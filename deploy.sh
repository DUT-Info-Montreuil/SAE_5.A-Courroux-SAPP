...
# #docker buildx build --platform linux/amd64 linux/amd64/v8 linux/arm64 --pull --rm -f "Dockerfile" -t courroux-sapp:0.0.1 "."
...
# #echo '8/8 Upload to the server'
# #scp -P 1215 dist/courroux-sapp.tar server@adresse_ip:/home/server/app/courroux-sapp/courroux-sapp.tar
# echo 'END'
# ENDTIME=$(date +%s)
